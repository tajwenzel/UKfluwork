...
polymodpull<-function(agesize, touchtype){
  ...
  for (kk in 1:8)
  {
    ...
    GBfinal<-select(workdata,local_id.x,participant_age,agegrp1,agegrp2,agegrp3,agegrp4,agegrp5,agegrp6,agegrp7,day)
    ...
    set<-na.omit(set)
    colnames(set)=c('V0','V1','V2','V3','V4','V5','V6','V7','V8','V9')
