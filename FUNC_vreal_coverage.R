...
function (riskratio, scenario, coveffin, season, new.cov) 
{
  ...
  if (scenario == 1) {
    ...
    calendar[t, c(1)] <- cov[[1]]
    calendar[t, c(2)] <- cov[[2]]
    calendar[t, c(3)] <- cov[[2]]
    calendar[t, c(4)] <- cov[[3]]
    calendar[t, c(5)] <- cov[[3]]
    calendar[t, c(6)] <- cov[[3]]
    calendar[t, c(7)] <- cov[[4]]
    calendar[t, c(8)] <- cov[[5]]
    calendar[t, c(9)] <- cov[[6]]
  ...
  if (scenario == 2) {
    ...
    calendar[t, c(1)] <- non
    calendar[t, c(2)] <- non
    calendar[t, c(3)] <- new.cov[[season]]#toddlers
    calendar[t, c(4)] <- non
    calendar[t, c(5)] <- non
    calendar[t, c(6)] <- non
    calendar[t, c(7)] <- non
  ...
  if (scenario == 3) {
    ...
    calendar[t, c(2)] <- non
    calendar[t, c(3)] <- non
    calendar[t, c(4)] <- new.cov[[season]]#primary
    calendar[t, c(5)] <- non
    calendar[t, c(6)] <- non
    calendar[t, c(7)] <- non
    calendar[t, c(8)] <- non
  ...
  if (scenario == 4) {
    ...
    calendar[t, c(3)] <- non
    calendar[t, c(4)] <- non
    calendar[t, c(5)] <- new.cov[[season]]
    calendar[t, c(6)] <- new.cov[[season]]
    calendar[t, c(7)] <- non
    calendar[t, c(8)] <- non
    calendar[t, c(9)] <- non
    calendar[t, c(10)] <- cov[[7]]
  ...
  if (scenario == 5) {
    ...
    calendar[t, c(1)] <- non
    calendar[t, c(2)] <- non
    calendar[t, c(3)] <- new.cov[[season]]
    calendar[t, c(4)] <- new.cov[[season]]
    calendar[t, c(5)] <- non
    calendar[t, c(6)] <- non
    calendar[t, c(7)] <- non
    calendar[t, c(8)] <- non
